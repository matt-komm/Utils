...
def listdir(path):
    ...
    while (ret!=0 and retry<20):
        ...
        while (proc.returncode==None and proc.poll()==None and waiting>0):
            time.sleep(0.1)
            waiting-=1
            try:
...
folders = listdir("srm://gfe02.grid.hep.ph.ic.ac.uk/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/mkomm/NANOX_170318-v1")
...
for i,folder in enumerate(folders):
    ...
    fileList = findFiles(
        "srm://gfe02.grid.hep.ph.ic.ac.uk/pnfs/hep.ph.ic.ac.uk/data/cms/store/user/mkomm/NANOX_170318-v1/"+folder["name"],
